...
background: linear-gradient(to left, #0DDC50, #212EA6);    padding: 3%;
    height:100%;
...
<form method="POST" action="target_mobile.php" enctype="multipart/form-data" class="register-form">
                ...
                <div class="row" style="height:100%">
                    ...
                    <div class="col-md-9 register-right">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link" id="home-tab" data-toggle="tab" href="index.php" role="tab" aria-controls="home" aria-selected="true">Website</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" id="profile-tab" data-toggle="tab" href="mobile.php" role="tab" aria-controls="profile" aria-selected="false">App</a>
                            </li>
                        </ul>
                                    ...
                                    <div class="form-group">
                                            <div class="maxl">
                                                <label class="radio inline"> 
                                                    <input type="radio" name="gender" value="binary">
                                                    <span> Black & White </span> 
                                                </label>
                                                &nbsp;&nbsp;
                                                <label class="radio inline"> 
                                                    <input type="radio" name="gender" value="colored" >
                                                    <span> Colored </span> 
                                                </label>
